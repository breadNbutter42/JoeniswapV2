/**
 *Submitted for verification at testnet.snowtrace.io on 2023-02-21
*/
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"60fdaba664d21437bcbb0bb88090ef8d24efed47a7fd3ad55511fc4985f0a670"//must set the factory hash here and the factory address in the constructor as well, 60fdaba664d21437bcbb0bb88090ef8d24efed47a7fd3ad55511fc4985f0a670 fuji, 
                    )
                )
            )
        );
...
contract JoeRouter02 is IJoeRouter02 {
    ...
    constructor() public { // also set the hash marked with constructor in the comment
        factory = 0x3F15f5a8a9c672dE5C89E8a345730862d195D23f; //0x3F15f5a8a9c672dE5C89E8a345730862d195D23f fuji
        WAVAX = 0xb788787fCA87B962646fECfcaA24e145082c21Dc; //0xb788787fCA87B962646fECfcaA24e145082c21Dc fuji
    }
